...
class ResPartnerTime(models.AbstractModel):
    ...
    def most_recent_next_day(self):
        ...
        adjusted_ar_timezone_hour = int(self.hour_to) + 3            
        return now.replace(hour=adjusted_ar_timezone_hour, minute=int(self.minute_to)) + timedelta(days=difference_to_target_weekday)
